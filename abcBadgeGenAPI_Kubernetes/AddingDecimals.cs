...
namespace abcBadgeGenAPI_Kubernetes //AddSubtractHugeNumbersCS
{
    //
    //Added 1/7/2019 thomas downes
    //
    public class AddingDecimals
    {
        //
        //Added 1/7/2019 thomas downes
        //

        public string AddAnyTwoDecStrings(string pstrDec1, string pstrDec2, ref string pstrErrMessage)
        {
        ...
        private string PadLeft(string paramString, int param_Length)
        {
        ...
        private string AddPaddedDecStrings(string pstrDec1, string pstrDec2, ref string pstrErrMessage)
        {
        ...
        private string AddDecDigits_ThenAddOneIfRequested(string pstrDecDigit1, string pstrDecDigit2,
        ...
        private string Add1_ForPriorOperation(string pstrDecDigit, ref bool pref_bCarry1, ref string pstrErrMessage)
        {
        ...
        public string AddDecDigits_ByArrays(string pstrDecDigit1, string pstrDecDigit2, 
        ...
        public char AddDecDigits_ByArrays_NotInUse(char pstrDecDigit1, char pstrDecDigit2,
                   ref bool pref_bCarryTheOne,
                   ref string pref_sErrorMessage)
        {
            //
