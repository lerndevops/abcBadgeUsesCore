...
//
//var T2_moveable_text = document.getElementById("id__mydivheaderT2");

//var T2_textbox_TopEdge = document.getElementsByName('T2.TopEdgePositionPixels')[0];
//var T2_textbox_LeftEdge = document.getElementsByName('T2.LeftEdgePositionPixels')[0];

//var T2_textbox_HeightPixels = document.getElementsByName('T2.HeightPixels')[0];
//var T2_textbox_WidthLengthPixels = document.getElementsByName('T2.WidthLengthPixels')[0];
//var T2_textbox_BackgroundColor = document.getElementsByName('T2.BackgroundColor')[0];

//var T2_badge_back = document.getElementsByName('badge_back')[0];
//T2_badge_back = document.getElementById("badge_back");

//
//  https://stackoverflow.com/questions/7942398/nested-objects-in-javascript-best-practices
//
var T2 = {
    moveable_text = document.getElementById("id__mydivheaderT2"),

    textbox_TopEdge = document.getElementsByName('T2.TopEdgePositionPixels')[0],
    textbox_LeftEdge = document.getElementsByName('T2.TopEdgePositionPixels')[0],

    textbox_HeightPixels = document.getElementsByName('T2.HeightPixels')[0],
    textbox_WidthLengthPixels = document.getElementsByName('T2.WidthLengthPixels')[0],
    textbox_BackgroundColor = document.getElementsByName('T2.BackgroundColor')[0],
    textbox_FontSize = document.getElementsByName('T2.FontSize')[0],
...
//
function T2_dragElement(parameter_element) {
    //  
    //Created 7/10/2019 thomas downes
    //

    //dragElement_T99('T2', parameter_element);

    dragElement_T99_T2(T2, parameter_element);
...
//
function dragElement_T99_T2(par_T99, parameter_element) {

    var pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 0;
    var boolResize = false;  //true; // false;//Added 5/26/2019 td

    //var box_topedge = $("#T1_TopEdgePositionPixels");
    //var box_leftedge = jQuery("#T1_LeftEdgePositionPixels");
    //var elem_TEXT = document.getElementsByName('T1.TopEdgePositionPixels')[0].value;

    //var boxHeightPixels = document.getElementsByName('T1.HeightPixels')[0];
    //var boxWidthLengthPixels = document.getElementsByName('T1.WidthLengthPixels')[0];
    //var badge_back = document.getElementById("badge_back");

    var intLeftEdge = 20;
    var intTopEdge = 20;

    //console.log('Is it found or not?  0 < TopEdgePositionPixels.Length = ' + $('#T1_TopEdgePositionPixels').length)
    //console.log('Is it found or not?  0< LeftEdgePositionPixels.Length = ' + $('#T1_LeftEdgePositionPixels').length)
    ...
    function elementDrag(event_e) {
        ...
        if (boolResize) {
            ...
            //document.getElementsByName('T1.TopEdgePositionPixels')[0].value = intTopEdge;
            //document.getElementsByName('T1.LeftEdgePositionPixels')[0].value = intLeftEdge;
