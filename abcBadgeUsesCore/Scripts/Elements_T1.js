...
//
//var T1_moveable_text = document.getElementById("id__mydivheaderT1");

//var T1_textbox_TopEdge = document.getElementsByName('T1.TopEdgePositionPixels')[0];
//var T1_textbox_LeftEdge = document.getElementsByName('T1.LeftEdgePositionPixels')[0];

//var T1_textbox_HeightPixels = document.getElementsByName('T1.HeightPixels')[0];
//var T1_textbox_WidthLengthPixels = document.getElementsByName('T1.WidthLengthPixels')[0];
//var T1_textbox_BackgroundColor = document.getElementsByName('T1.BackgroundColor')[0];

//var T1_badge_back = document.getElementsByName('badge_back')[0];
//T1_badge_back = document.getElementById("badge_back");
...
//
var T1 = {
    moveable_text = document.getElementById("id__mydivheaderT1"),

    textbox_TopEdge = document.getElementsByName('T1.TopEdgePositionPixels')[0],
    textbox_LeftEdge = document.getElementsByName('T1.TopEdgePositionPixels')[0],

    textbox_HeightPixels = document.getElementsByName('T1.HeightPixels')[0],
    textbox_WidthLengthPixels = document.getElementsByName('T1.WidthLengthPixels')[0],
    textbox_BackgroundColor = document.getElementsByName('T1.BackgroundColor')[0],
    textbox_FontSize = document.getElementsByName('T1.FontSize')[0],
...
//
function T1_dragElement(parameter_element) {
    //  
    //Created 7/10/2019 thomas downes
    //

    //dragElement_T99('T1', parameter_element);

    dragElement_T99_T1(T1, parameter_element);
...
//
function dragElement_T99_T1(par_T99, parameter_element) {
