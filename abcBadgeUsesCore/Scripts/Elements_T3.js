...
//
//var T3_moveable_text = document.getElementById("id__mydivheaderT3");

//var T3_textbox_TopEdge = document.getElementsByName('T3.TopEdgePositionPixels')[0];
//var T3_textbox_LeftEdge = document.getElementsByName('T3.LeftEdgePositionPixels')[0];

//var T3_textbox_HeightPixels = document.getElementsByName('T3.HeightPixels')[0];
//var T3_textbox_WidthLengthPixels = document.getElementsByName('T3.WidthLengthPixels')[0];
//var T3_textbox_BackgroundColor = document.getElementsByName('T3.BackgroundColor')[0];

//var T3_badge_back = document.getElementsByName('badge_back')[0];
//T3_badge_back = document.getElementById("badge_back");
...
//
var T3 = {
    moveable_text = document.getElementById("id__mydivheaderT3"),

    textbox_TopEdge = document.getElementsByName('T3.TopEdgePositionPixels')[0],
    textbox_LeftEdge = document.getElementsByName('T3.TopEdgePositionPixels')[0],

    textbox_HeightPixels = document.getElementsByName('T3.HeightPixels')[0],
    textbox_WidthLengthPixels = document.getElementsByName('T3.WidthLengthPixels')[0],
    textbox_BackgroundColor = document.getElementsByName('T3.BackgroundColor')[0],
    textbox_FontSize = document.getElementsByName('T3.FontSize')[0],
...
//
function T3_dragElement(parameter_element) {
    //  
    //Created 7/10/2019 thomas downes
    //

    //dragElement_T99('T3', parameter_element);

    dragElement_T99_T3(T3, parameter_element);
...
//
function dragElement_T99_T3(par_T99, parameter_element) {

    var pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 0;
    var boolResize = false;  //true; // false;//Added 5/26/2019 td

    //var box_topedge = $("#T3_TopEdgePositionPixels");
    //var box_leftedge = jQuery("#T3_LeftEdgePositionPixels");
    //var elem_TEXT = document.getElementsByName('T3.TopEdgePositionPixels')[0].value;

    //var boxHeightPixels = document.getElementsByName('T3.HeightPixels')[0];
    //var boxWidthLengthPixels = document.getElementsByName('T3.WidthLengthPixels')[0];
    //var badge_back = document.getElementById("badge_back");

    var intLeftEdge = 20;
    var intTopEdge = 20;

    //console.log('Is it found or not?  0 < TopEdgePositionPixels.Length = ' + $('#T3_TopEdgePositionPixels').length)
    //console.log('Is it found or not?  0< LeftEdgePositionPixels.Length = ' + $('#T3_LeftEdgePositionPixels').length)
    ...
    function elementDrag(event_e) {
        ...
        if (boolResize) {
            ...
            //document.getElementsByName('T3.TopEdgePositionPixels')[0].value = intTopEdge;
            //document.getElementsByName('T3.LeftEdgePositionPixels')[0].value = intLeftEdge;
